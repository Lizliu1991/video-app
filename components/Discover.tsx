...
const topicStyles = "xl:border-2 hover:bg-primary xl:border-gray-300 px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-black"
...
{topics.map((item) => (
  ...
  <div className={topic === item.name ? activeTopicStyle : topicStyles}>
